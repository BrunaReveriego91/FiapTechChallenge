...
namespace FiapTechChallenge.API.Tests.UnitTests.Fakes
{
    public class FakeConta
    {
        ...
        public static List<Conta> GetList(int qtdeRegistros = 1)
        {
            var contaFaker = new Faker<Conta>("pt_BR")
                ...
                .RuleFor(c => c.DadosBancarios, new List<DadosBancario>()
                {
                    new Faker<DadosBancario>("pt_BR")
